...
public abstract class BaseViewHolder<V> extends RecyclerView.ViewHolder {
     ...
     */
    protected abstract void bindData(V itemValue, int position, OnViewClickListener listener);
     ...
     * @param listener
     */
    public void setData(V itemValue, int position, OnViewClickListener listener) {
